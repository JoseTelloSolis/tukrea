      ...
      <div class="dashboard_graph">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <form id="formulario" class="form form-horizontal periodico" role="form" method="POST" action="{{ route('admin.listado.editar', $datos->id) }}" enctype="multipart/form-data">
              ...
              <div class="card card-primary">
                ...
                <div class="card-header">
                  <div class="panel-title">Editar Listado Escolar</div>
                </div>  
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div id="container-productos" class="col-lg-6"> 
                      ...
                      @forelse ($datosProductos as $datoProducto)
                        <div id="div-producto" class="row div-producto mb-3">
                          <div class="col-sm-7">
                            <select class="form-control id-producto">
                              @foreach ($productos as $dato)
                                @if($datoProducto->id_producto == $dato->id)
                                  <option value="{{ $dato->id }}" selected>{{ $dato->codigo }} - {{ $dato->nombre }}</option>
                                @else
                          ...
                          <div class="col-sm-4">
                            <input type="number" class="form-control cantidad" placeholder="Cantidad" value="{{ $datoProducto->cantidad }}">
                          </div>
                          <div class="col-sm-1">
