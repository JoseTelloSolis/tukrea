        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <span class="help-block">
              <a href="{{ route('admin.grupos') }}"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Volver al listado de Grupos</a>
            </span>

            <br><br>

            <form class="form form-horizontal periodico" role="form" method="POST" action="{{ route('admin.grupo.editar', $datos->id) }}" enctype="multipart/form-data">
              ...
              <div class="card card-primary">
                ...
                <div class="card-header">
                  <div class="panel-title">Editar Grupo</div>
                </div>  
