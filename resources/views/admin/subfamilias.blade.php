          ...
          <div class="col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                <div class="panel-title">Sub-Familias</div>
              </div>  
                    ...
                    <tbody>
                      ...
                      @foreach ($datos as $dato)                        
                        <tr> 
                          ...
                          <td><a href="{{ route('admin.subfamilia', $dato->id) }}" class="editar boton-editar" title="Editar"><span class="glyphicon glyphicon-pencil"></span></a></td>
                        </tr>
                      @endforeach
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#actualizar').click(function(e) {
        ...
        $.ajax({
          url: '{{ route("admin.subfamilias.actualizar") }}',
          type: 'GET',   
