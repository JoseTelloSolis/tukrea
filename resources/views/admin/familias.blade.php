          ...
          <div class="col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                <div class="panel-title">Familias</div>
              </div>  
                    ...
                    <tbody>
                      ...
                      @foreach ($familias as $dato)                        
                        <tr> 
                          ...
                          <td><a href="{{ route('admin.familia', $dato->id) }}" class="editar boton-editar" title="Editar"><span class="glyphicon glyphicon-pencil"></span></a></td>
                        </tr>
                      @endforeach
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#actualizar').click(function(e) {
        ...
        $.ajax({
          url: '{{ route("admin.familias.actualizar") }}',
          type: 'GET',   
