      ...
      <div class="dashboard_graph">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <form class="form form-horizontal periodico" role="form" method="POST" action="{{ route('admin.slider.editar', $datos->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-12">                  
                      ...
                      <!-- imagen -->
                      <span class="help-block">
                        Click en la imagen para actualizarla <span>- 1140 x 420 px</span>
                      </span>
