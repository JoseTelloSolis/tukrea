          ...
          <div class="col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                <div class="panel-title">Grados</div>
              </div>  
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <div class="div-tabla-boton">
                    <a href="{{ route('admin.grados.crear') }}" class="btn btn-success btn-md mb-2"><i class="fa fa-file"></i> Nuevo Grado</a>
                  </div> 
                    ...
                    <tbody>
                      ...
                      @foreach ($grados as $dato)                        
                        <tr data-rel="{{ $dato->id }}"> 
                          ...
                          <td><a href="{{ route('admin.grados.editar', $dato->id) }}" class="editar boton-editar" title="Editar"><span class="glyphicon glyphicon-pencil"></span></a></td>
                          <td><a href="{{ route('admin.grados.eliminar', $dato->id) }}" class="editar boton-editar eliminar" title="Eliminar"><span class="glyphicon glyphicon-remove"></span></a></td>
                        </tr>
                      @endforeach
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#table-responsive').on('click', '.eliminar', function(e){
        ...
        var confirmacion = confirm("Esta por eliminar un grado. ¿Aún desea hacerlo?");
      ...
      $("#table-responsive tbody").sortable({
        ...
        update: function( event, ui ) {
          ...
          $.ajax({
            ...
            url:   "{{ route('admin.grados.ordenar') }}",
            type:  'get',
            beforeSend: function() {
