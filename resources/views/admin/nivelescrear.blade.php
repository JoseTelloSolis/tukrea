      ...
      <div class="dashboard_graph">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <form class="form form-horizontal periodico" role="form" method="POST" action="{{ route('admin.niveles.crear') }}" enctype="multipart/form-data">
              ...
              <div class="card card-primary">
                ...
                <div class="card-header">
                  <div class="panel-title">Crear Nivel</div>
                </div>  
