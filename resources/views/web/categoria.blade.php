  ...
  <section class="section-tabs">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <ul class="tabs">
            @if ($datosCategoria->id == 4)
              <li class="tab col s3"><a href="#test1" class="active">INDIVIDUAL</a></li>
              <li class="tab col s3"><a href="#test2">COLECCIONES</a></li>
            @elseif ($datosCategoria->id == 3)
              <li class="tab col s3"><a href="#test1" class="active">TEXTOS</a></li>
              <li class="tab col s3"><a href="#test2">PLAN LECTOR</a></li>
            @elseif ($datosCategoria->id == 2)
              <li class="tab col s3"><a href="#test1" class="active">INDIVIDUAL</a></li>
            @else
              <li class="tab col s3"><a href="#test1" class="active">INDIVIDUAL</a></li>
            ...
            <div class="row">
              <div class="col s12 right-align">
                ...
                <div class="input-field container-filtros">
                  <input type="hidden" id="idcat" value="{{ $datosCategoria->id }}">
                  <select id="ordenar">
                    ...
                    @if ($datosCategoria->id == 3)
                      <option value="grado-menor">Grado menor</option>
                      <option value="grado-mayor">Grado mayor</option>
                    @endif
                  </select>
            ...
            @if ($datosCategoria->id == 3)
              ...
              <div class="row">
                <div class="col s12 right-align">
                  ...
                  <div class="products buscar">
                    <div class="input-field ma-0">
                      <input id="texto-buscar2" type="text" placeholder="Buscar">
                      <button type="button" id="buscar2" class="btn-flat"><i class="material-icons">search</i></button>
                    </div>
                  </div>                 
                </div>
              </div>
              ...
              <div id="product-list2" class="row product-list">

                <div class="col s12 div-pagination2">
                  <ul class="pagination2 right">
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    var datos2 = @json($planLector);
    var $page2 = jQuery('#product-list2');
    var $currentPage2 =  1;
    var itemsPerPage2 = 8;
    var $numberOfPages2;
    var $productsList2 = jQuery('#product-list2 .product-container');
    var $productsCount2 = $productsList2.length;
    ...
    function mostrarDatos2(arrayDatos) {
      ...
      jQuery('#product-list2').empty();
      jQuery('#product-list2').html(output);  

      $productsList2 = jQuery('#product-list2 .product-container');
      $productsCount2 = $productsList2.length;
      //$productDetails = jQuery('#product-list .product-container .product-column');
    ...
    function ordenarGradoMenor(a, b){
      var aName = parseFloat(a.orden);
      var bName = parseFloat(b.orden); 
      return ((aName < bName) ? -1 : ((aName > bName) ? 1 : 0));
    }

    function ordenarGradoMayor(a, b){
      var aName = parseFloat(a.orden);
      var bName = parseFloat(b.orden); 
      return ((aName > bName) ? -1 : ((aName < bName) ? 1 : 0));
    }
    ...
    $(document).ready(function(){
      ...
      $('#ordenar').change(function(){
        ...
        else if(orden == 'grado-menor') {
          datos.sort(ordenarGradoMenor);
          mostrarDatos(datos);
        }
        else if(orden == 'grado-mayor') {
          datos.sort(ordenarGradoMayor);
          mostrarDatos(datos);
        }
      ...
      if(idcat == 3) {
        $('#ordenar').val('grado-menor').trigger('change');
        $('#ordenar').val('grado-menor').formSelect();
      }
      ...
      $('#ordenar2').change(function(){

        var orden = $(this).val();

        if(orden == 'az') {
          datos2.sort(ordenarAZ);
          mostrarDatos2(datos2);
        }
        else if(orden == 'za') {
          datos2.sort(ordenarZA);
          mostrarDatos2(datos2);
        }
        else if(orden == 'precio-menor') {
          datos2.sort(ordenarMenorMayor);
          mostrarDatos2(datos);
        }
        else if(orden == 'precio-mayor') {
          datos.sort(ordenarMayorMenor);
          ...
          datos2.sort(ordenarGradoMenor);
          mostrarDatos2(datos2);
        }
        else if(orden == 'grado-mayor') {
          datos2.sort(ordenarGradoMayor);
          mostrarDatos2(datos2);
        }
      ...
      $('#buscar2').click(function(){
        var texto = $('#texto-buscar2').val();

        var resultados = buscar(datos2, texto);

        mostrarDatos2(JSON.parse(resultados));
        $('.gallery').trigger( "click" );
      });

      $('#texto-buscar2').bind("enterKey",function(e){
        var texto = $('#texto-buscar2').val();
      ...
      $('#texto-buscar2').keyup(function(e){
        if(e.keyCode == 13){
          $(this).trigger("enterKey");
        }
      });

      $('#product-list2').on('submit', '.formulario', function(e){
